...
const MemberFollowers = (props: MemberFollowsProps) => {
	...
	useEffect(() => {
		getFollowersRefetch({ input: followInquiry });
	}, [followInquiry]);
										...
										{follower.meFollowed && follower.meFollowed[0]?.myFollowing ? (
											<>
												...
												<Button
													...
													onClick={() => unsubscribeHandler(follower?.followerData?._id, getFollowersRefetch, followInquiry)}
												>
													Unfollow
												</Button>
											</>
											...
											<Button
												...
												onClick={() => subscribeHandler(follower?.followerData?._id, getFollowersRefetch, followInquiry)}
											>
												Follow
											</Button>
										)}
